...
# plt.xlabel('Episodes')
# plt.ylabel('Score')
# plt.title('Q-Learning in CartPole-v1')
# plt.savefig('q_cartpole.png')
# plt.show()

plt.plot(range(len(mean_reward_record)),mean_reward_record)
plt.xlabel('Every {} Episodes'.format(CHECKPOINT_INTERVAL))
plt.ylabel('Mean Score')
plt.title('Q-Learning in CartPole-v1 (Checkpoint Interval {})'.format(CHECKPOINT_INTERVAL))
plt.savefig('mean_q_cartpole.png')
plt.show()